...
@section('header')
    <section class="header-operation container-fluid animated fadeIn d-flex mb-2 align-items-baseline d-print-none" bp-section="page-header">
        <h1 class="text-capitalize mb-0" bp-section="page-heading">Product Details</h1>
        <p class="ms-2 ml-2 mb-0" bp-section="page-subheading">Edit this product</p>
...
<div class="row" bp-section="crud-operation-create">
	<div class="{{ $crud->getCreateContentClass() }}">
        ...
        <form method="post" class="card" action="{{ route('products.update', ['id' => $entry->id]) }}">
        ...
        {!! csrf_field() !!}
            ...
            <div class="row">
                <div class="col-md-12 px-4">
                    <div class="row">
                                <h3 class="form-group-heading m-0"><i class="la la-plus me-2"></i> Add New Product</h3>

                                <div class="form-group col-md-4">
                                    <label for="product_name">Product Name</label>
                                    <input type="text" class="form-control" id="product_name" name="product_name"
                                           value="{{ old('product_name', $entry->product_name ?? '') }}" placeholder="Product Name" required>
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="price">Price</label>
                                    <input type="text" class="form-control" id="price" name="price"
                                           value="{{ old('price', $entry->price ?? '') }}" placeholder="Price" required>
                                </div>
                                ...
                                <div class="form-group col-md-4 d-flex align-items-end">
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="available_to_account_holders"
                                               name="available_to_account_holders" value="1"
                                               {{ old('available_to_account_holders', $entry->available_to_account_holders ?? true) ? 'checked' : '' }}>
...
{{--                                </div>--}}
                    ...
                    <div class="px-4 mt-2">
                        ...
                        <button type="button" class="btn btn-secondary btn-submission mx-2" onclick="window.location.href='/admin/product'">
                            Close
                        </button>
                ...
                <form id="delete-form" method="POST" action="{{ route('product.custom_delete', $entry->id) }}" style="display:none;">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
